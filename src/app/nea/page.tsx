...
export default async function NewsElPage() {
  ...
  return (
    <PageShell
      ...
      heroFit="cover"
      introduction={[
        "Οι πιο πρόσφατες δράσεις του Συλλόγου, οι επόμενες εκδηλώσεις και οι πρωτοβουλίες της κοινότητας συγκεντρώνονται εδώ. Δείτε τι συμβαίνει στην κοιλάδα και πώς μπορείτε να συμμετέχετε.",
      ]}
      sections={[]}
      locale="el"
      afterSections={
