...
export default function ReligionPage() {
  return (
    <PageShell
      title="Θρησκεία"
      introduction={[
        "Ο καθολικός Ι. Ναός του Αγίου Μιχαήλ στον Ταραμπάδο αποτελεί μία από τις 30 ενορίες της Καθολικής Αρχιεπισκοπής Νάξου – Τήνου – Άνδρου – Μυκόνου. Ο υπάρχων ναός χρονολογείται από το 1810, ενώ το έτος ίδρυσης της ενορίας είναι το 1789.",
        "Το εξωκλήσι του Αγίου Χαραλάμπους καταγράφεται από το 1828 ως ναός των ορθοδόξων κατοίκων, με ρίζες που φτάνουν τουλάχιστον μέχρι το 1726, σηματοδοτώντας τα συμβολικά όρια προστασίας του χωριού.",
      ]}
      sections={[
        {
