    ...
    <PageShell
      ...
      sections={[
        ...
        },
        {
          ...
          paragraphs: [
            "Απαγορεύεται η προσπάθεια αλλοίωσης ή μη εξουσιοδοτημένης πρόσβασης στο διαχειριστικό περιβάλλον. Οι τεχνικές αλλαγές καταγράφονται αυτόματα στο ιστορικό ανάπτυξης.",
          ],
        },
      ]}
      locale="el"
