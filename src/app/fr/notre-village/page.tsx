...
export default function NotreVillageFr() {
  return (
    <PageShell
      ...
      sections={[
        {
          heading: "Origines et toponymie",
          paragraphs: [
            "On ignore si la migration était due à une nouvelle épidémie ou à une invasion, mais elle fut massive : Potamos n’est plus cité que comme zone agricole. Tarambados doit son nom au surnom « Tarambas », sans doute celui d’un propriétaire terrien local.",
            "La terminaison –ados caractérise de nombreux villages érigés durant les périodes génoise (1207-1390) et vénitienne (1390-1715), selon l’organisation féodale qui regroupait les agriculteurs autour des demeures aristocratiques.",
          ],
        },
        {
          heading: "Évolutions historiques",
          paragraphs: [
